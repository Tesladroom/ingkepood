...
i18n
  ...
  .init({
    resources,
    lng: localStorage.getItem("languaega"), // language to use, more information here: https://www.i18next.com/overview/configuration-options#languages-namespaces-resources
